	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h3>1.Srushti Yerawar </br>2 .Priyanka Kshirsagar </br>3.Pratibha Khandagale </br> 4.Utkarsha Deshmukh<h4><h4>Studing Btech in Computer Engineering </h4>
							<h5>MIT Academy of Engineering Pune.</h5>
						<p>														cell: +91 8888888888</p><br>
				</article>
			</div>
			<div class="col-md-6">
